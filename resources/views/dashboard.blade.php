            ...
            <div class="h-full flex overflow-hidden gap-3 sm:rounded-lg">
                ...
                <div class="flex-1 flex flex-col border-2 rounded-lg p-6 lg:p-8 gap-4">
                    ...
                    <div class="bg-white border-2 rounded-lg flex p-4 items-center">
                        ...
                        <span class="italic font-bold">Do Androids Dream of Electric Sheep?</span> Es una interfaz reimaginada de la célebre harramienta de procesamiento de lenguaje natural "Chat-GPT" creada por OpenAI. El objetivo de esta nueva interfaz es demostrar la habilidad de los desarrolladores por trabajar con herramientas de DevOps para el curso de Softserve "DevOps Crash Course".
                    </p>
                </div>
                
                <div class="flex-1 flex flex-col border-2 rounded-lg p-6 lg:p-8 gap-4">
                    <div class="bg-white border-2 rounded-lg flex p-4 flex-1">
                        
                    </div>
                
                    <div class="bg-white border-2 rounded-lg flex p-4 items-center">
                        <textarea name="user-message" id="user-message" rows="1" class="m-0 w-full resize-none border-0 bg-transparent p-0 pr-10 focus:ring-0 focus-visible:ring-0 dark:bg-transparent md:pr-12 pl-3 md:pl-0" placeholder="Type your dream away."></textarea>
