                    ...
                    <div class="bg-white border-2 rounded-lg flex p-4 items-center">
                        <form class="flex space-x-2 flex-1" wire:submit.prevent="storeData">
                            ...
                            <button class="p-1 h- mr-0 ml-auto mb-0 mt-auto" wire:loading.attr="disabled" @if(empty($this->message)) disabled @endif>
                                ...
                                <svg wire:loading wire:target="submitMessage" aria-hidden="true" class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
