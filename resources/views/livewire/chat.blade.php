            ...
            <div class="h-full flex overflow-hidden gap-3 sm:rounded-lg">
                <div class="max-w-sm p-6 lg:p-8 bg-white border-2 rounded-lg">
                    ...
                    <div class="relative mt-2">
                        <input type="search" id="search"
                            class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-search focus:ring-blue-500 focus:border-blue-500"
                            placeholder="Busque un mensaje..." wire:model="search">
                    </div>
                </div>
                ...
                <div class="flex-1 flex flex-col border-2 rounded-lg p-6 lg:p-8 gap-4 bg-frame bg-opacity-90">
                    <div id="chat-messages"
                        class="scrollbar scrollbar-thumb-scrollBar scrollbar-track-gray-400 scrollbar-thumb-rounded-full scrollbar-track-rounded-full bg-white border-2 rounded-lg flex flex-col p-4 flex-1 overflow-wrap overflow-y-auto">
                        @forelse ($messages as $message)
                            ...
                            <div class="chat chat-start">
                                <p
                                    class="chat-bubble bg-responseBubble bg-opacity-70 mb-3 text-gray-700 dark:text-gray-700">
                    ...
                    <div class="bg-white border-2 rounded-lg flex p-4 items-center">
                        <form class="flex space-x-2 flex-1" wire:submit.prevent="storeData">
                            <textarea
                                class="scrollbar-thin scrollbar-thumb-scrollBar scrollbar-track-gray-400 scrollbar-thumb-rounded-full scrollbar-track-rounded-full m-0 w-full resize-none border-0 bg-search p-0 pr-10 focus:ring-0 focus-visible:ring-0 dark:bg-transparent md:pr-12 pl-3 md:pl-0 text-gray-500 dark:text-gray-500"
                                placeholder="Type your dream away." id="input-message" name="input-message" autofocus maxlength="300"
                            ...
                            <button class="p-1 h- mr-0 ml-auto mb-0 mt-auto" wire:loading.attr="disabled">
                                <svg wire:loading.remove wire:target="storeData" class="stroke-slate-700" width="24"
                                ...
                                <svg wire:loading wire:target="storeData" aria-hidden="true"
